...
export const environment = {
  production: false,
  //confirmaccounturl:'http://localhost:8080/GetCustomerByAccountNo',
  //customerdetailsurl:'http://localhost:8080/CustomerDetails',
  //fundaccounturl:'http://localhost:8080/FundAccount',
  //transhistoryurl:'http://localhost:8080/TransHistory',
